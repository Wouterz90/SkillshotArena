...
TREE_REGROW_TIME = 30                -- How long should it take individual trees to respawn after being cut down/destroyed?
...
CAMERA_DISTANCE_OVERRIDE = 1100        -- How far out should we allow the camera to go?  Use -1 for the default (1134) while still allowing for panorama camera distance changes
...
FORCE_PICKED_HERO = nil --"npc_dota_hero_pudge"              -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
