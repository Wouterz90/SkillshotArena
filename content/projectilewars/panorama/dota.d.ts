...
interface CDOTA_PanoramaScript_GameUI {
     ...
     */
    PingMinimapAtLocation(Vector: [number, number, number]): void;
     ...
     */
    SetCameraTargetPosition(Vector: [number, number, number], flLerp: number): void;
}
...
interface CScriptBindingPR_Game {
     ...
     *
     */
    CreateCustomKeyBind(keyName: string,commandName:any): void;
